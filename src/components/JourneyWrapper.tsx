...
interface Props {
  ...
  actionPlansByCareer: Record<string, string>;
}

export function JourneyWrapper({ careers, countriesByCareer, examsByCareerCountry, unisByCareerCountry, actionPlansByCareer }: Props) {
  return (
    <Journey
      careers={careers}
      ...
      actionPlans={actionPlansByCareer}
    />
  );
}
